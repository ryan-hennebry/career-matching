...
- [Remote-Operator Sweep Jun 2026](remote-operator-sweep-jun2026.md) — Jun 10 REMOTE/hybrid-light angle: ZERO confirmed-live net-new. Bob W AI-Ops Lead=best fit but 404 on own ATS; Mirelo/bunch=DE/EU-auth; Jobgether Lever=aggregator(3837)/no-UK; Runlayer=EA. generalist.world WORKS.
- [Bob W recheck Jun 2026](bob-w-recheck-jun2026.md) — Jun 11 2nd recheck: Bob W AI Ops Lead STILL NOT live (absent from own Teamtailor careers.bobw.co/jobs, only on stale BeBee/TheirStack). Lesson: TheirStack "Until DD/MM" ≠ live. Stop rechecking.
